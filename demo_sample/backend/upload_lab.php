...
try {
    ...
    $filepath = sprintf('../../test/ml/sample_img/lab/%s' ,$_FILES['file']['name']);
    ...
    //SCRIPT
    if(!file_exists("../../test/gradcam/output/lab/".$_FILES['file']['name'])){
   shell_exec("cd ../../test/gradcam/ && python main.py --input ../../test/ml/input20/lab/".$_FILES['file']['name']." --output output/lab/".$_FILES['file']['name']." --layer_name pool5");
    }
